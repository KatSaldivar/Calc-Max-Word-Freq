...
class LineAnalyzer
  ...
  def calculate_word_frequency()
    ...
    @highest_wf_words = words.select {|k,v| v == @highest_wf_count }.keys
  end
end
...
class Solution
  ...
  def analyze_file()
    ...
    begin
      ...
      text_file = File.open('test.txt') 
      # =>  store each line as an object of LineAnalyzer
      text_file.each_with_index do |line, index|
  ...
  def calculate_line_with_highest_frequency
    ...
    @highest_count_across_lines = @analyzers.sort {|x,y| y.highest_wf_count <=> x.highest_wf_count}.first.highest_wf_count
